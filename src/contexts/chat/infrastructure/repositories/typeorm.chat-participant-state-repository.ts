...
import { ChatParticipantState } from "../../domain/entities/chatParticipantState";
import { ChatParticipantStateRepository } from "../../domain/repositories/chat-participant-state.repository";
import { ChatParticipantStateEntity } from "../persistence/chat-participant-state.orm.entity";
import { ChatEntity } from "../persistence/chat.entity";

export class TypeOrmChatParticipantStateRepository extends ChatParticipantStateRepository {
  constructor(

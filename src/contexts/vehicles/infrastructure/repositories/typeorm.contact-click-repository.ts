...
import { ContactClick } from "../../domain/entities/contact-click";
import { ContactClickRepository } from "../../domain/repositories/contact-click.repository";
import { ContactClickEntity } from "../persistence/contact-click.entity";

@Injectable()
export class TypeOrmContactClickRepository implements ContactClickRepository {
  constructor(
    @InjectDataSource()

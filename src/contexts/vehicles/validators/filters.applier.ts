...
export const applyFilters = (
  ...
  if (has_non_empty_string_array(filters.categories_slugs)) {
    qb.andWhere("category.slug IN (:...categories_slugs)", {
      categories_slugs: trim_slug_array(filters.categories_slugs),
    });
  }

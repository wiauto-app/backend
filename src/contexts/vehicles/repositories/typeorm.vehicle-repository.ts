import { TypeOrmVehicleAnalyticsRepository } from "./typeorm.vehicle-analytics-repository";
...
export class TypeOrmVehicleRepository {
  constructor(
    ...
    private readonly vehicle_analytics_repository: TypeOrmVehicleAnalyticsRepository,
  ) {
  }

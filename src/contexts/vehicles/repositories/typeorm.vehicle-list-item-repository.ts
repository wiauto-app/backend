...
import { VehicleListItemNotFoundException } from "../exceptions/vehicle-list-item-not-found.exception";
import { VehicleListDetailItem } from "../types/vehicle-list-detail";
...
@Injectable()
export class TypeOrmVehicleListItemRepository {
  constructor(

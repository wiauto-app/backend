...
import { FileQueuePort } from "@/src/contexts/shared/file/ports/file-queue.port";

import { BulkVehicleImagesDto } from "../dto/bulk-vehicle-images.dto";
import { Injectable } from "@/src/contexts/shared/dependency-injectable/injectable";

@Injectable()
export class BulkVehicleImagesService {

...
export class OutboundMailEnqueueService {
  ...
  async enqueue_insurance_lead_notification(
    data: OutboundMailInsuranceLeadNotificationJobData,
  ): Promise<void> {
    await this.outbound_mail_queue.add(
      OUTBOUND_MAIL_JOB_INSURANCE_LEAD_NOTIFICATION,
      data,
  ...
  async enqueue_newsletter_subscribed(
    data: OutboundMailNewsletterSubscribedJobData,
  ): Promise<void> {
    await this.outbound_mail_queue.add(
      OUTBOUND_MAIL_JOB_NEWSLETTER_SUBSCRIBED,
      data,
  ...
  async enqueue_lead_assistant_reply(
    data: OutboundMailLeadAssistantReplyJobData,
  ): Promise<void> {
    await this.outbound_mail_queue.add(OUTBOUND_MAIL_JOB_LEAD_ASSISTANT_REPLY, data);
  }
}

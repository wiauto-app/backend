...
export class VehiclesProfileCascade1786604790444 implements MigrationInterface {
    name = 'VehiclesProfileCascade1786604790444'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vehicles" ADD CONSTRAINT "FK_e0bb01d7655ad76dafdf0f674b2" FOREIGN KEY ("profile_id") REFERENCES "profile"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

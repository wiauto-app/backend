...
export class DniDeleted1787418442483 implements MigrationInterface {
    name = 'DniDeleted1787418442483'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_plan_access_grants_active_lookup" ON "plan_access_grants" ("expires_at", "profile_id") WHERE (revoked_at IS NULL)`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_plan_access_grants_one_current_per_profile" ON "plan_access_grants" ("profile_id") WHERE (revoked_at IS NULL)`);
    }

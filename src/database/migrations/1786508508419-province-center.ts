...
export class ProvinceCenter1786508508419 implements MigrationInterface {
    name = 'ProvinceCenter1786508508419'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "provinces" ADD "center" geometry(Point,4326)`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_047ed058516cfde3d1d5447dde" ON "provinces" USING GiST ("center") `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_047ed058516cfde3d1d5447dde"`);
        ...
        await queryRunner.query(`ALTER TABLE "provinces" DROP COLUMN "center"`);
    }

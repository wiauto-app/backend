...
import { CuotasController } from "@/contexts/vehicles/infrastructure/http-api/cuotas-v1/cuotas.controller";
import { CuotasUseCase } from "@/contexts/vehicles/application/cuotas-use-cases/cuotas.use-case";

describe("CuotasController", () => {
  let controller: CuotasController;
  let useCase: Mock<CuotasUseCase>;

  beforeEach(() => {
    useCase = createMock<CuotasUseCase>();
    controller = new CuotasController(useCase);
  });

  describe("create", () => {
    it("should call use case create with dto", () => {
      const dto = { name: "Cuota 1" };
      const expected = { id: 1 };
  ...
  describe("findAll", () => {
    it("should call use case findAll with query", () => {
      ...
      const expected = [{ id: 1, name: "Cuota 1" }];
    ...
    it("should return empty array when no cuotas found", () => {

...
import { VehicleTypesController } from "@/contexts/vehicles/infrastructure/http-api/vehice-types-v1/vehicle-types.controller";
import { VehicleTypesUseCase } from "@/contexts/vehicles/application/vehicle-types-use-cases/vehicle-types.use-case";

describe("VehicleTypesController", () => {
  let controller: VehicleTypesController;
  let useCase: Mock<VehicleTypesUseCase>;

  beforeEach(() => {
    useCase = createMock<VehicleTypesUseCase>();
    controller = new VehicleTypesController(useCase);
  });

  describe("create", () => {
    it("should call use case create with dto", () => {
      const dto = { name: "Sedan", image_url: "http://example.com/sedan.png" };
      const expected = { id: 1 };
  ...
  describe("update", () => {
    it("should call use case update with id and destructured dto", () => {
      const dto = { name: "SUV", image_url: "http://example.com/suv.png" };
      const expected = { id: 1 };
  ...
  describe("findAll", () => {
    it("should call use case findAll with query", () => {
      ...
      const expected = [{ id: 1, name: "Sedan" }];
    ...
    it("should return empty array when no vehicle types found", () => {
